	...
	public payment() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			if(c2.isSelected())
			{
			 ...
			 if(c3.isSelected())
			{
				t3.setText(Integer.toString(self=2020));
			 ...
			 if(c4.isSelected())
			{
				t4.setText(Integer.toString(therapy=1500));
			 ...
			 if(c5.isSelected())
			{
				...
				t5.setText(Integer.toString(gene=1570));
			...
			if(c6.isSelected())
			{
				...
				t6.setText(Integer.toString(rekhi=1550));	
		...
		t6 = new JTextField();
		t6.setBounds(193, 292, 86, 20);
		contentPane.add(t6);
		t6.setColumns(10);
		
		JTextArea at = new JTextArea();
		at.setBounds(612, 127, 321, 419);
		contentPane.add(at);
		...
		btnReceipt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				at.setText("\tONLINE BILLING SYSTEM\n\n******************************************************************\n"
						+ "\tconsultation:        "+t2.getText()+"\n"
						+ "\tdiet chart:              "+t1.getText()+"\n"
						+ "\ttherapy yoga:        "+t4.getText()+"\n"
						+ "\tgeneral yoga:        "+t5.getText()+"\n"
						+"\trekhi :                     "+t6.getText()+"\n"
						+"\tself defence:         "+t3.getText()+"\n"
						+"\ttax         :                 "+5+"\n"
						+"***********************************************************************************\n"
						+"\t total :                    "+t9.getText()+"\n" 
						+"***********************************************************************************\n"
